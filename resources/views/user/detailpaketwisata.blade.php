...
<style>
    ...
    .slider-controls {
        ...
        position: absolute;
        bottom: 0;
        /* Menempatkan slider control di bagian bawah */
        left: 0;
        right: 0;
    }
    ...
    .package-card-small {
        padding: 10px;
        /* Ruang dalam package-card-small */
        background: #fff;
        /* Warna latar belakang */
        border: 1px solid #e0e0e0;
        /* Border */
                ...
                <div class="modal-body">
                    <form action="{{ route('storepemesanan') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah_orang" id="jumlah_orang" class="form-control" data-harga="{{ $paketWisata->harga }}" required>
                        </div>
                        <div class="form-group">
...
<script>
    ...
    document.getElementById('jumlah_orang').addEventListener('input', function() {
        ...
        var hargaPaket = parseFloat(this.getAttribute('data-harga'));
