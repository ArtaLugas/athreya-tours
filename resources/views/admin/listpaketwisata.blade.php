...
<style>
    ...
    .slider-wrapper {
        position: relative;
        overflow: hidden;
        /* Menggunakan overflow untuk efek transisi */
    }
    ...
    .slider-image {
        ...
        /* Efek transisi dengan transform, opacity, dan border */
        opacity: 1;
        /* Mulai dengan opacity penuh */
        transform: scale(1);
        /* Mulai dengan transform normal */
                                ...
                                <td>
                                    ...
                                    <div class="image-slider" data-index="{{ $loop->index }}">
                                        <div class="slider-wrapper">
                                            ...
                                            <img src="{{ asset('uploads/paketWisata/' . $image) }}" style="max-width: 200px; max-height: 200px; @if ($index !== 0) display: none; @endif" alt="{{ $paket->nama_paket }}" class="slider-image">
                                            @endforeach
